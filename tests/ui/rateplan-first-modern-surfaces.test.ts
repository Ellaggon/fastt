...
describe("ui/rateplan-first modern surfaces", () => {
	...
	it("tarifa presenta las condiciones en lenguaje humano y reserva trazabilidad para detalle", () => {
		...
		expect(surface).toContain("Define horarios contractuales de llegada y salida")
		expect(surface).not.toContain("Configurar hotel")
		expect(surface).not.toContain("providerHouseRules")
