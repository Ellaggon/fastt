...
describe("S4-2 settings hub coach slim", () => {
	it("keeps activation focused on one next-step CTA", () => {
		...
		expect(page).toContain("fastt-row-card")
		expect(page).toContain("data-settings-row-icon")
		expect(page).toContain("ShieldCheck")
		expect(page).toContain("FileText")
		expect(page).toContain("ReceiptText")
		expect(page).toContain("CircleDollarSign")
		expect(page).toContain("fastt-row-card-info")
		expect(page).toContain("fastt-row-card-danger")
		expect(page).toContain("fastt-row-card-alert")
		expect(page).toContain("bg-sky-50/80")
		expect(page).toContain("text-slate-950")
		expect(page).toContain("ArrowRight")
		expect(page).toContain("data-settings-next-step-icon")
		expect(page).toContain("--fastt-color-selection")
		expect(page).toContain("En curso")
		...
		expect(hydration).toContain("fastt-row-card")
		expect(hydration).toContain("data-settings-row-icon")
		expect(hydration).toContain("areaIcons")
		expect(hydration).toContain("badgeClasses.info")
		expect(hydration).toContain('variant: "info"')
