...
describe("Guardrail: Rooms & Rates operational semantics", () => {
	...
	it("keeps Pricing and Inventory as calendar-first operational owners with pricing extension inside Calendar", () => {
		...
		expect(pricingAutomationPanel).toContain("Automatiza descuentos, aumentos o precios fijos")
		...
		expect(calendarOperationalController).toContain("setAutomationPopoverOpen")
		expect(calendarOperationalController).toContain('event.key === "Escape"')
		expect(calendarOperationalController).toContain("automationPresets.contains")
		expect(pricingAutomationPanel).toContain("data-pricing-automation-selected-title")
		expect(calendarOperationalController).toContain("automationSelectedTitle.textContent")
		...
		expect(pricingAutomationPanel).toContain("Reglas activas")
		expect(pricingAutomationPanel).toContain("Estas reglas seguirán modificando precios")
