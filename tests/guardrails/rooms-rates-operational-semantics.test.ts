...
describe("Guardrail: Rooms & Rates operational semantics", () => {
	...
	it("keeps Pricing and Inventory as calendar-first operational owners with Bulk as secondary action", () => {
		...
		expect(governance).toContain('label: "Extender cambio"')
		...
		expect(pricing).toContain("Extender cambio actual")
		expect(pricing).toContain("Ayudas recurrentes")
		expect(pricing).toContain("Tres intenciones, un solo origen")
		expect(pricing).toContain("Selecciona fechas en el calendario")
		expect(pricing).toContain("data-pricing-automation-presets")
		expect(pricing).toContain("Crear ayuda recurrente")
		expect(pricing).toContain("Simple primero")
		expect(pricing).toContain("data-pricing-advanced-panel")
		expect(pricing).toContain("Acciones avanzadas para la selección")
		...
		expect(pricing).toContain("Abrir detalle avanzado")
