...
describe("Guardrail: Rooms & Rates operational semantics", () => {
	...
	it("keeps Pricing and Inventory as calendar-first operational owners with pricing extension inside Calendar", () => {
		...
		expect(pricing).toContain("¿Se vende esta noche?")
		expect(pricing).toContain("Cupo:")
		expect(pricing).toContain("Reservas:")
		expect(pricing).toContain("Holds:")
		expect(pricing).toContain("Regla:")
		expect(pricing).toContain("Condiciones:")
		...
		expect(pricing).toContain("Venta")
		expect(pricing).toContain('data-operational-tab="policies"')
		expect(pricing).toContain('data-operational-tab="recurring"')
		expect(pricing).toContain('data-operational-tab="bulk"')
		expect(pricing).toContain('data-operational-tab="technical"')
		expect(pricing).toContain("Reglas recurrentes")
		expect(pricing).toContain("Operación masiva")
		expect(pricing).toContain("allowedOperationalTabs")
		expect(pricing).toContain('["price", "availability", "restrictions", "policies"]')
		...
		expect(pricing).toContain("data-panel-inventory-detail")
		expect(pricing).toContain("Ver detalle físico")
		expect(pricing).toContain("hasInventoryIssue")
		expect(pricing).toContain("isProfessionalCalendar || hasInventoryIssue")
		...
		expect(pricing).toContain("const initialFocusableCard")
		expect(pricing).toContain("selectPricingDate(initialFocusableCard.getAttribute")
		expect(pricing).toContain('activeOperationalTab === "restrictions"')
		expect(pricing).toContain("setRestrictionDrawerOpen(true)")
		...
		expect(pricing).toContain("con reglas de venta")
