...
describe("Guardrail: Rooms & Rates operational semantics", () => {
	...
	it("keeps Calendar operational and moves recurring sellability rules into Multicalendario", () => {
		...
		expect(multiCalendar).toContain('{ id: "rules_manage", label: "Ver reglas", kind: "rules" }')
		expect(multiCalendar).toContain(
			'{ id: "rules_conflicts", label: "Ver conflictos", kind: "rules" }'
		)
		expect(multiCalendar).toContain('{ id: "rules_history", label: "Historial", kind: "rules" }')
		expect(multiCalendar).not.toContain('{ id: "rules_create"')
		expect(multiCalendar).toContain('id="multiCalendarRulesPanel"')
		expect(multiCalendar).toContain('id="multiCalendarRuleEditor"')
		expect(multiCalendar).toContain("selectedAppliedRules")
		expect(multiCalendar).toContain("conflictPairs")
		expect(multiCalendar).toContain("Vigencia desde")
		expect(multiCalendar).toContain("No hay reglas en esta selección")
		...
		expect(multiCalendar).toContain("Crear variante")
		expect(multiCalendar).not.toContain(">Duplicar<")
		...
		expect(multiCalendar).toContain("No hay meses anteriores editables")
		...
		expect(multiCalendar).toContain('id="multiCalendarConditionsPanel"')
		expect(multiCalendar).toContain("renderConditionsPanel")
		expect(multiCalendar).toContain('id: "conditions_manage"')
		expect(multiCalendar).toContain("conditionsActionLabel")
		expect(multiCalendar).toContain("Completar condiciones")
		expect(multiCalendar).toContain("Ver condiciones")
		expect(multiCalendar).toContain("Revisar condiciones")
		expect(multiCalendar).not.toContain('id: "conditions_resolve"')
		expect(multiCalendar).not.toContain('id: "conditions_view"')
		expect(multiCalendar).toContain('data-assignment-scope="rate_plan"')
