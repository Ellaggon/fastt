...
describe.skip("legacy/ui rateplan hardening implementation details", () => {
	it("legacy: rutas variant-first de pricing redirigen al hub ratePlan-first", () => {
		const files = [
	...
	it("legacy: onboarding pricing crea/usa ratePlanId y no envía variantId al endpoint de base rate", () => {
