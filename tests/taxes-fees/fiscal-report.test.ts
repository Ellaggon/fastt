...
const quote = buildPriceQuote({
	...
	taxesAndFees: {
		base: 100,
		taxes: { included: [{ definitionId: "tax-1", code: "VAT", name: "VAT", kind: "tax", inclusionType: "included", amount: 10, collectionResponsibility: "provider", taxableBase: "booking_base" }], excluded: [] },
		fees: { included: [], excluded: [{ definitionId: "fee-1", code: "SERVICE", name: "Service", kind: "fee", inclusionType: "excluded", amount: 5, collectionResponsibility: "platform", taxableBase: "booking_base" }] },
		total: 105,
	},
