...
INSERT INTO "InternalRole" ("id", "key", "label", "description") VALUES
	...
	('internal_role_verification_reviewer', 'verification_reviewer', 'Revisor de verificación', 'Revisa identidad y negocio; no puede decidir pagos ni fiscalidad.'),
...
JOIN "InternalPermission" permissions ON (roles."key", permissions."key") IN (
	...
	('verification_reviewer', 'internal.admin.access'), ('verification_reviewer', 'provider.compliance.read'), ('verification_reviewer', 'provider.verification.review'), ('verification_reviewer', 'case.decision.propose'),
