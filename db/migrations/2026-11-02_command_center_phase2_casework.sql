...
-- Initial deterministic policy: Bolivia, accommodation, intermediary/PSP. It is deliberately narrow.
INSERT INTO "CompliancePolicySet" ("id","key","label","country","vertical","collectionModel","status") VALUES ('cps_bo_accommodation_intermediary_v1','bo-accommodation-intermediary','FASTT Bolivia · alojamientos · intermediario','BO','accommodation','intermediary','active') ON CONFLICT ("key") DO NOTHING;
INSERT INTO "CompliancePolicyVersion" ("id","policySetId","version","status","effectiveFrom","approvedAt") VALUES ('cpv_bo_accommodation_intermediary_v1','cps_bo_accommodation_intermediary_v1',1,'published','2026-01-01T00:00:00Z','2026-01-01T00:00:00Z') ON CONFLICT ("policySetId","version") DO NOTHING;
