...
export const backofficeRouteClassifications: BackofficeRouteClassification[] = [
	...
	},
	{
		...
		owner: "Provider Setup",
		rationale:
			"Legacy redirect hacia /provider/settings/tax-fees. Impuestos y cargos son setup comercial del proveedor; finanzas consume los snapshots resultantes.",
	},
	{
		pattern: "/analytics/**",
		status: "transitional",
	...
	},
	{
		...
		context: "governance",
		owner: "Provider Setup",
		rationale: "Legacy redirect hacia /provider/settings.",
	},
	{
		...
		context: "governance",
		owner: "Provider Setup",
		rationale: "Legacy redirect hacia /provider/settings/profile.",
	},
	{
	...
	},
	{
		...
		context: "governance",
		owner: "Provider Setup",
		rationale: "Legacy redirect hacia /provider/settings/verification.",
	},
	{
		pattern: "/admin/**",
	...
	{
		pattern: "/api/cron/external-calendars",
		status: "internal-only",
		context: "internal-ops",
		owner: "Provider Integrations",
		rationale: "Scheduled external calendar sync worker; cron-secret auth only.",
	},
	{
		pattern: "/api/cron/provider-integrations",
		status: "internal-only",
		context: "internal-ops",
		owner: "Provider Integrations",
	...
	},
	{
		...
		rationale: "Cron entrypoints are platform-operated and must not be provider-facing.",
	},
	{
		pattern: "/api/ical/exports/:exportId.ics",
		status: "public",
		context: "public-marketplace",
		owner: "Provider Integrations",
		rationale: "Token-gated iCal export feed for external channel managers.",
	},
	{
		pattern: "/api/ical/**",
		status: "public",
		context: "public-marketplace",
		owner: "Provider Integrations",
		rationale: "Public calendar export surfaces authenticated by per-export token.",
	},
	{
		pattern: "/404",
		status: "public",
	...
	},
	{
		...
		context: "public-marketplace",
		owner: "Public Marketplace",
		rationale: "Consumer whole-home discovery and detail routes.",
	},
	{
		pattern: "/destinos/**",
		status: "public",
	...
	{
		pattern: "/checkout/tours",
		status: "public",
		context: "public-marketplace",
		owner: "Public Marketplace",
		rationale: "Guest tour checkout after an inventory hold.",
	},
	{
		pattern: "/help",
		status: "public",
