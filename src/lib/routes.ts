export const routes = {
	...
	providerSettingsTaxReports: () => "/provider/settings/tax-fees/reports",
	providerSettingsTaxAssignments: () => "/provider/settings/tax-fees/assignments",
	providerSettingsTaxSimulator: () => "/provider/settings/tax-fees/simulator",
	providerSettingsTaxActivity: () => "/provider/settings/tax-fees/activity",
	...
	providerTaxReports: () => "/provider/settings/tax-fees/reports",
