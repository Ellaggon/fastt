...
export const channelManagerVendors: ChannelManagerVendorCatalogItem[] = [
	{
		...
		credentialPlaceholder: "Endpoint HTTPS o credencial del proveedor",
	...
	},
	{
		...
		credentialPlaceholder: "API key de Cloudbeds",
	...
	},
	{
		...
		credentialLabel: "API key de Channex",
		credentialPlaceholder: "API key de Channex",
		help: "Fastt valida el acceso y consulta las propiedades disponibles sin exponer la credencial.",
