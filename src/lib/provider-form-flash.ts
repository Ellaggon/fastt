...
export function providerFormErrorMessage(field: string, fallback = "Revisa este campo.") {
	const messages: Record<string, string> = {
		...
		holderCountry: "Usa un código de país de dos letras, por ejemplo CL.",
		taxResidenceCountry: "Usa un código de país de dos letras, por ejemplo CL.",
		payoutCountry: "Usa un código de país de dos letras, por ejemplo CL.",
