	...
	body.innerHTML = `
		<section class="space-y-4">
			<div class="fastt-drawer-attention p-5">
				...
				<h2 class="mt-2 text-2xl font-semibold tracking-[-0.02em] text-slate-950">${escapeHtml(item.caseLabel)}</h2>
			...
			<details class="fastt-drawer-section p-4">
				...
				<pre class="${financialUi.technicalPre} max-h-72">${escapeHtml(JSON.stringify(item.raw, null, 2))}</pre>
			</details>
		</section>`
