...
import { InventoryBootstrapService } from "@/core/inventory/InventoryBootstrapService"
...
export const POST: APIRoute = async ({ request, params }) => {
	...
	try {
		...
		/* 2️⃣ BOOTSTRAP AUTOMÁTICO INVENTARIO */

		const bootstrap = new InventoryBootstrapService()
		...
		return new Response(JSON.stringify({ ok: true, id: hotelRoomId, variantId }), { status: 201 })
	} catch (err) {
