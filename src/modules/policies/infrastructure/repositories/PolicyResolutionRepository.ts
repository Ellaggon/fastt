	...
	async listActivePoliciesByGroupIds(params: {
		...
		for (const r of rows as any[]) {
			...
			out[gid] = {
				...
				status: "active",
				policyPresetKey: r.policyPresetKey == null ? null : String(r.policyPresetKey),
				stayLengthType: r.stayLengthType == null ? null : String(r.stayLengthType),
				gracePeriod: r.gracePeriod == null ? null : Number(r.gracePeriod),
