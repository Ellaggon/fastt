 ...
 *
 * FinancialReference records that an external reference is visible for operational
...
export type FinancialReferenceSource = "operator_entry" | "legacy_payload" | "import"
